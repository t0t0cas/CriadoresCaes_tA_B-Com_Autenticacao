...
namespace CriadoresCaes_tA_B.Areas.Identity.Pages.Account {
   [AllowAnonymous]
      ...
      public async Task<IActionResult> OnPostAsync(string returnUrl = null) {
         ...
         if (ModelState.IsValid) {
            ...
            if (result.Succeeded) {
               ...
               Input.Criador.Email = Input.Email; // atribuir ao objeto 'criador' o email fornecido pelo utilizador,
               ...
               try {
                  _context.Add(Input.Criador); // adicionar o Criador
