...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.Caes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.Criadores", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.CriadoresCaes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.Fotografias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.Racas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.Caes", b =>
                {
                    b.HasOne("CriadoresCaes_tA_B.Models.Racas", "Raca")
            ...
            modelBuilder.Entity("CriadoresCaes_tA_B.Models.CriadoresCaes", b =>
                {
                    b.HasOne("CriadoresCaes_tA_B.Models.Caes", "Cao")
                        .WithMany("ListaCriadores")
                        .HasForeignKey("CaoFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CriadoresCaes_tA_B.Models.Criadores", "Criador")
                        .WithMany("ListaDeCaes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CriadoresCaes_tA_B.Data.ApplicationUser", null)
                        .WithMany()
